...
--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "pickup_latitude" numeric(10, 7);--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "pickup_longitude" numeric(10, 7);--> statement-breakpoint
ALTER TABLE "vehicles" ADD COLUMN "pickup_address" varchar(500);--> statement-breakpoint
DO $$ BEGIN
