  ...
  return (
    <>
      <PageHeader
        eyebrow="Inbox"
        title="Messages"
        subtitle="Chat with your renters in real time."
      />
      <div className="dash-panel flex h-[clamp(420px,75dvh,720px)] flex-col overflow-hidden rounded-2xl shadow-[0_8px_32px_rgba(15,23,42,0.08)]">
